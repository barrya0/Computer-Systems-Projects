...
<p align="center"> <img src="exp_imgs/1000x1000_ms.png" alt="drawing" width="75%"/> </p>
    ...
    There isn't much of a difference observed between this case and case (v) so I will leave out the graph. 
...
This data seems to support the idea that the best 1+1 method for matrix-matrix multiplication is Multi-threading that uses SIMD programming as this has the fastest execution time.
